#!/usr/bin/env python3
"""Conformance checks for the public Contract A RC2 candidate authority.

This evaluator is intentionally frozen outside candidate/. A fresh independent
implementer may receive the public candidate authority without receiving this
reference evaluator.
"""
